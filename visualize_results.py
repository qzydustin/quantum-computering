...
def load_results():
    ...
    try:
        with open('tmp/circuit_comparison_results.json', 'r') as f:
            comparison_results = json.load(f)
        
        with open('tmp/sequence_analysis.json', 'r') as f:
...
def visualize_tvd_with_sequences(comparison_results, sequence_analysis, output_dir='tmp'):
    """
...
def main():
    ...
    comparison_results, sequence_analysis = load_results()
    ...
    # Save summary to CSV
    output_csv = 'tmp/tvd_summary.csv'
